    ...
    <div className={convert.convert_box}>
      ...
      <div className={convert.convert_form}>
        <form className={convert.form}>
          ...
          <button
            ...
            onClick={(event) => handleClickConvert(event)}
          >
            Конвертировать
          </button>
        </form>
      ...
      <div className={convert.content}>
        {loading ? (
          ...
          <>
            <span className={convert.date}>
              {dataConvert && `ЦБ РФ на ${dataConvert.date}`}
            </span>
            <div className={convert.result_box}>
              <span className={convert.result_amount}>
                {dataConvert && dataConvert.query.amount}
              </span>
              <span className={convert.result_fromTo}>
                {dataConvert && dataConvert.query.from}
              </span>
              <span>{dataConvert && " = "}</span>
              <span className={convert.result}>
                {dataConvert && dataConvert.result}
              </span>
              <span className={convert.result_fromTo}>
                {dataConvert && dataConvert.query.to}
              </span>
